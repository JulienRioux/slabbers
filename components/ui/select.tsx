...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        "border-input bg-background dark:bg-input/30 flex h-9 w-full items-center justify-between gap-2 rounded-md border px-3 py-1 text-sm shadow-xs transition-[color,box-shadow] outline-none",
    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport
          ...
          className={cn(
            "max-h-full overflow-y-auto p-1",
            position === "popper" &&
